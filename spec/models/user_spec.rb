...
RSpec.describe User, type: :model do
  ...
  it "is not saved with password containing only alphabets" do
    user = User.create username:"Pekka", password:"SecretS", password_confirmation:"SecretS"
  ...
  describe "favorite style" do
    ...
    it "is the one with highest rating if several rated" do
      ...
      style = Style.create name: "cool", description: "good"
  ...
  describe "with a proper password" do
    ...
    it "and with two ratings, has the correct average rating" do
      ...
      # Brewery needs to have unique name
      brewery = FactoryBot.create(:brewery, name: "unique123")
      # Beer needs to have unique name
      beer = FactoryBot.create(:beer, name: "unique123", brewery: brewery) 
